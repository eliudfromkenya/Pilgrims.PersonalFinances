            ...
            modelBuilder.Entity("BudgetDebt", b =>
                {
                    ...
                    b.ToTable("BudgetDebt", (string)null);
                });
            ...
            modelBuilder.Entity("Pilgrims.PersonalFinances.Models.AssetInsurance", b =>
                {
                    ...
                    b.ToTable("AssetInsurances", (string)null);
                });
            ...
            modelBuilder.Entity("Pilgrims.PersonalFinances.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDirty = true,
                            Name = "Debt Payment",
                            UpdatedAt = new DateTime(2025, 9, 29, 5, 52, 3, 768, DateTimeKind.Utc).AddTicks(1159)
                        },
                        new
                        {
                            Id = "2",
                            ...
                            IsDirty = true,
                            Name = "Interest",
                            UpdatedAt = new DateTime(2025, 9, 29, 5, 52, 3, 768, DateTimeKind.Utc).AddTicks(4321)
                        },
                        new
                        {
                            Id = "3",
                            ...
                            IsDirty = true,
                            Name = "Credit Card",
                            UpdatedAt = new DateTime(2025, 9, 29, 5, 52, 3, 768, DateTimeKind.Utc).AddTicks(4329)
                        });
                });
            ...
            modelBuilder.Entity("Pilgrims.PersonalFinances.Models.InsuranceBeneficiary", b =>
                {
                    ...
                    b.ToTable("InsuranceBeneficiaries", (string)null);
                });
            ...
            modelBuilder.Entity("Pilgrims.PersonalFinances.Models.InsuranceDocument", b =>
                {
                    ...
                    b.ToTable("InsuranceDocuments", (string)null);
                });
            ...
            modelBuilder.Entity("Pilgrims.PersonalFinances.Models.InsuranceNotification", b =>
                {
                    ...
                    b.ToTable("InsuranceNotifications", (string)null);
                });
            ...
            modelBuilder.Entity("Pilgrims.PersonalFinances.Models.InsurancePremiumPayment", b =>
                {
                    ...
                    b.ToTable("InsurancePremiumPayments", (string)null);
                });
            ...
            modelBuilder.Entity("Pilgrims.PersonalFinances.Models.ObligationBenefit", b =>
                {
                    ...
                    b.ToTable("ObligationBenefits", (string)null);
                });
            ...
            modelBuilder.Entity("Pilgrims.PersonalFinances.Models.ObligationDocument", b =>
                {
                    ...
                    b.ToTable("ObligationDocuments", (string)null);
                });
            ...
            modelBuilder.Entity("Pilgrims.PersonalFinances.Models.ObligationNotification", b =>
                {
                    ...
                    b.ToTable("ObligationNotifications", (string)null);
                });
