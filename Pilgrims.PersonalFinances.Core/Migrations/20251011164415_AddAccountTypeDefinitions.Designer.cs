...
namespace Pilgrims.PersonalFinances.Core.Migrations
{
    ...
    [Migration("20251011164415_AddAccountTypeDefinitions")]
    partial class AddAccountTypeDefinitions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pilgrims.PersonalFinances.Models.AuditEntry", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Pilgrims.PersonalFinances.Models.AuditLog", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Pilgrims.PersonalFinances.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDirty = true,
                            Name = "Debt Payment",
                            UpdatedAt = new DateTime(2025, 10, 11, 16, 44, 12, 755, DateTimeKind.Utc).AddTicks(1087)
                        },
                        new
                        {
                            Id = "2",
                            ...
                            IsDirty = true,
                            Name = "Interest",
                            UpdatedAt = new DateTime(2025, 10, 11, 16, 44, 12, 755, DateTimeKind.Utc).AddTicks(2205)
                        },
                        new
                        {
                            Id = "3",
                            ...
                            IsDirty = true,
                            Name = "Credit Card",
                            UpdatedAt = new DateTime(2025, 10, 11, 16, 44, 12, 755, DateTimeKind.Utc).AddTicks(2221)
                        });
                });
            ...
            modelBuilder.Entity("Pilgrims.PersonalFinances.Models.AuditEntry", b =>
                {
                    b.HasOne("Pilgrims.PersonalFinances.Models.AuditLog", "AuditLog")
